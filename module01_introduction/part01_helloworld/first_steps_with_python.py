...
def play_with_list_and_dictionary():
    ...
    """
    Python's 'lists' are data structures used to store sequences of variables. They are similar to arrays in Java/C/C++
    ...
    """
    Python's 'dictionaries' are maps (or "hash tables"), that is, data structures storing pairs (key, value),
