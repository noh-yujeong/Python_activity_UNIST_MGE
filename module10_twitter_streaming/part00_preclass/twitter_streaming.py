...
if __name__ == '__main__':
    ...
    access_token = "1056573876115632130-ALMk0G8pWDNx7TX4b3lJGqjaIt8Mh1"
    access_token_secret = "GRfdEdweqyEuBTC1lRHdYwfvlrI92jCcNd7WCEZF1PSEo"
    consumer_key = "Uj1KGsqiFmCNJGXHZLvWRZNKg"
    consumer_secret = "W4Uow0NFAnhI2iU9fgRGzrNtCpAVv6C3ydziseSNbLKRaNzFs9"
    ...
    stream.filter(track=['iu', 'IU'], async = True)         # track all the tweets in which the keywords 'brexit' and 'Brexit' appear, the async option makes sure that tracking does not block teh execution of the program
