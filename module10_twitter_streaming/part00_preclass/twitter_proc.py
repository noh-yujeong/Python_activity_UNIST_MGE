...
Note that the Twitter "stream" listener stores tweets in the JSON format. JSON is a lightweight standard data interchange format.
...
if __name__ == '__main__':
    ...
    for tweet_dict in tweet_list:
        ...
        print("a.{0}".format(tweet_dict['user']['statuses_count']))
